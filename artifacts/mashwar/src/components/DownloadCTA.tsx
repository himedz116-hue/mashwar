...
export default function DownloadCTA() {
  return (
    <section id="download" className="py-16 md:py-24 bg-[#EFF7E8] relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-stretch">
            {/* Text side */}
            <div className="flex-1 p-7 md:p-12 lg:p-16 text-right flex flex-col justify-center">
              <motion.div
              ...
              <h2 className="text-3xl md:text-5xl font-heading font-black text-white mb-4 md:mb-5 leading-tight">
                جاهز لتنفيذ
                <br />
                <span className="text-[#D4EDA8]">مشوارك الأول؟</span>
              </h2>
              <p className="text-white/70 text-sm md:text-lg mb-7 md:mb-10 leading-relaxed max-w-md">
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4">
                ...
                <motion.a
                  ...
                  className="flex items-center gap-3 px-5 py-3.5 md:px-6 md:py-4 rounded-2xl bg-white text-[#000201] hover:bg-[#D4EDA8] transition-all duration-300 shadow-xl"
                >
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/>
                  </svg>
                  <div>
                    <div className="text-[10px] md:text-xs opacity-60">حمل من</div>
                ...
                <motion.a
                  href="#"
                  whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}
                  className="flex items-center gap-3 px-5 py-3.5 md:px-6 md:py-4 rounded-2xl bg-white/15 border border-white/30 text-white hover:bg-white/25 transition-all duration-300"
                >
                  <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <div>
                    <div className="text-[10px] md:text-xs text-white/60">حمل من</div>
              ...
              {/* Mobile trust badges */}
              <div className="flex items-center gap-5 mt-6 md:hidden">
                {[
                  { icon: "⭐", text: "٤.٩ تقييم" },
                  { icon: "🔒", text: "آمن ومضمون" },
                  { icon: "⚡", text: "طلب في ٣٠ ث" },
                ].map((b) => (
                  <div key={b.text} className="flex items-center gap-1.5 text-white/70 text-xs">
                    <span>{b.icon}</span>
                    <span>{b.text}</span>
                  </div>
                ))}
            ...
            {/* Illustration — hidden on small mobile, visible md+ */}
            <div className="hidden sm:flex flex-1 justify-center items-end overflow-hidden px-4 md:px-0">
              <motion.div
              ...
              >
                ...
                <motion.img
                  ...
                  alt="مشوار"
                  className="relative w-full max-w-[400px] md:max-w-[520px] drop-shadow-2xl object-contain"
                  animate={{ y: [0, -8, 0] }}
