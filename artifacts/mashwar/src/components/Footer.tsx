export default function Footer() {
  ...
  return (
    <footer className="bg-[#000201] text-white/60">
      <div className="container mx-auto px-4 md:px-8 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12 pb-12 border-b border-white/10">
          ...
          <div className="md:col-span-1">
            <img src="/logo.png" alt="مشوار" className="h-9 w-auto mb-5 brightness-200" />
            ...
            <div className="flex gap-3">
              {["X", "in", "ig"].map((s) => (
                <a
                  key={s}
                  href="#"
                  className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-sm font-bold hover:bg-[#679632] hover:border-[#679632] hover:text-white transition-all duration-300"
                >
                  {s}
                </a>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              {[
                ...
                <li key={link.label}>
                  <a href={link.href} className="hover:text-[#99C169] transition-colors">
                    {link.label}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              {[
                ...
                <li key={item}>
                  <a href="#" className="hover:text-[#99C169] transition-colors">
                    {item}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <div className="mt-6 flex flex-col gap-3">
              <a
                href="#"
                className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-white/5 border border-white/10 hover:border-[#679632]/50 hover:text-[#99C169] transition-all text-sm font-bold"
              >
              ...
              <a
                href="#"
                className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-[#679632]/15 border border-[#679632]/30 hover:bg-[#679632]/25 text-[#99C169] transition-all text-sm font-bold"
              >
                <svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between text-sm gap-4">
          ...
          <p className="text-[#679632] font-bold">صُنع بفخر في السعودية</p>
        </div>
      </div>
    </footer>
  );
